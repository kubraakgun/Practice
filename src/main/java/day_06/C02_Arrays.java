...
public class C02_Arrays {
    ...
    public static void main(String[] args) {
      ...
      int[] arr ={100, 10001, -90, 845, 8787, 898, 0, 1};
        // int arr[]
        //sort methodu array elemanlarini natural order a gore siralar (alfabetik/ kucukten buyuge)

        System.out.println(Arrays.toString(arr));//[100, 10001, -90, 845, 8787, 898, 0, 1]
        Arrays.sort(arr);//arr arrayi kucukten buyuge siralanmis oldu

        System.out.println(Arrays.toString(arr));//[-90, 0, 1, 100, 845, 898, 8787, 10001]


        System.out.println("minimum : " + arr[0]);
        System.out.println("maksimum : " + arr[arr.length-1]);// [] parantezin içine index yazmamiz gerekiyor,son index arr.lenght-1 dir
